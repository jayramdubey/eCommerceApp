...
public class CartController {
    ...
    @ApiOperation("Update quantity of items already present in cart")
    @RequestMapping(value ="/updateItemQuantity/{productId}/{quantity}",method= RequestMethod.POST)
    public String updateItemQuantity(@PathVariable("productId") Long productId , @PathVariable("quantity") int quantity){
